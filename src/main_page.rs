...
use rust_lib::api::{
    ...
    shared_resources::{
        collection::{use_collections_radio, use_keys, CollectionId},
        entry::STORAGE,
    },
};
use tailwind_fuse::*;
...
pub const BLOCK: Asset = manganis::asset!("/assets/block.svg");
pub const EXPAND_CONTENT: Asset = manganis::asset!("/assets/expand_content.svg");
pub const ICON: Asset = manganis::asset!("/assets/icon.svg");
pub const LIGHTNING: Asset = manganis::asset!("/assets/lightning.svg");
pub const IMG: Asset = manganis::asset!("/assets/project.png");
pub const STAR: Asset = manganis::asset!("/assets/award_star.svg");
pub const ARROW_LEFT: Asset = manganis::asset!("/assets/keyboard_arrow_left.svg");
